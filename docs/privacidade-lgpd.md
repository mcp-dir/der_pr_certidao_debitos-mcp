...
DER PR: Certidão Negativa de Débitos (por placa) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [der_pr_certidao_debitos@mcp.ai](mailto:der_pr_certidao_debitos@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
